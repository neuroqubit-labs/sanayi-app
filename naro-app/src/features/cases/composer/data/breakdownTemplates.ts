...
const ENGINE_TEMPLATE: BreakdownTemplate = {
  ...
  evidence: [
    ...
    },
    {
      id: "engine_sound",
      title: "Duyduğun ses",
      hint: "Motor çalışırken duyduğun sesi kaydedebilirsin.",
      kinds: ["audio"],
      maxPhotos: 2,
    },
    {
  ...
  evidence: [
    {
      ...
      hint: "Yanan ışıklar görünüyorsa fotoğraf veya kısa video ekle.",
      kinds: ["photo", "video"],
      maxPhotos: 2,
      required: true,
    },
    {
      ...
      hint: "Marşta veya çalışırken duyduğun sesi ekleyebilirsin.",
      kinds: ["audio"],
      maxPhotos: 1,
    },
    {
      ...
      hint: "Uygunsa sigorta kutusunun fotoğrafını ekleyebilirsin.",
      kinds: ["photo"],
      maxPhotos: 1,
    },
  ],
...
const TRANSMISSION_TEMPLATE: BreakdownTemplate = {
  ...
  evidence: [
    ...
    },
    {
      id: "trans_sound",
      title: "Duyduğun ses",
      hint: "Vites değiştirirken duyduğun sesi ekleyebilirsin.",
      kinds: ["audio"],
      maxPhotos: 2,
    },
    {
