...
| R016 | OPERASYON | Yol 2 (Naro Acente Ltd.) ilan edildiğinde Kayseri yerel sigorta acenteleri "rakipsiniz" diye Kanal C kullanıcı edinme partnership'ini keser → pilot/ölçek kullanıcı edinme kaybı | L2 | I2 | 4 | Yol 2 lansman planı sırasında "iki-taraflı pazarlama" sözleşme şablonu hazır olmalı; yerel acenteleri "yan satış kanalı + komisyon paylaşımı" olarak konumla. Detay [monetizasyon/sigorta-yan-gelir-stratejisi.md](../monetizasyon/sigorta-yan-gelir-stratejisi.md) §5. | 2026-04-24 |
